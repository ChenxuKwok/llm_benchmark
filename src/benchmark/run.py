...
from benchmark.runners.gemini_runner import GeminiRunner
...
def run_benchmark(
    ...
    if backend == "openai":
        ...
        if not project or not location:
            raise ValueError("project and location are required for Gemini backend")
        runner = GeminiRunner(project=project, location=location)
    else:
